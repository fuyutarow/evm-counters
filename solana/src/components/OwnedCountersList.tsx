...
export function OwnedCountersList() {
  ...
  if (isLoading) {
    return (
      <Card>
        <CardHeader>
          <CardTitle>Your Owned Counters</CardTitle>
        </CardHeader>
        <CardContent>
  ...
  if (error) {
    return (
      <Card>
        ...
        <CardContent>
          <p className="py-8 text-center text-muted-foreground">Failed to load owned counters</p>
        </CardContent>
      </Card>
    );
  }
      ...
      <Card>
        ...
        <CardContent>
          <p className="py-8 text-center text-muted-foreground">
            No owned counters found. Create your first counter above!
          </p>
        </CardContent>
      </Card>
    );
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>Your Owned Counters ({counters.length})</CardTitle>
      </CardHeader>
      <CardContent>
            ...
            >
              ...
              <div className="flex items-center gap-2">
                <Button asChild variant="outline" size="sm">
                  <Link href={`/owned-counter/${counter.id}`}>View Details</Link>
                </Button>
